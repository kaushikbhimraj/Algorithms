...
class RecentCounter:
    ...
    def __init__(self):
        # Store timestamps in time.
        self.times = []

    def ping(self, t: int) -> int:
        self.times.append(t)
        
        # The domains are constantly updated by with [t-3000, t]
        # In this scenario, you will add the current timestamp and remove, 
        # all timestamps that fall out of the domain. 
        while self.times:
            if self.times[0] < t-3000:
                self.times.pop(0)
            else:
                break
        
        # Size of remaining timestamps is what is required. 
