...
class Solution:
    ...
    Cases:
        ...
        Skip all the white spaces by skipping it.
    """
    def myAtoi(self, str: str) -> int:
        ...
        #i:        index
        #res:      converted integer
        #negative: to make the integer +/-
        i = 0
        res = 0
        negative = 1
        ...
        #Check for sign after skipping whitespaces
        ...
        #As numbers are expected after the signs
