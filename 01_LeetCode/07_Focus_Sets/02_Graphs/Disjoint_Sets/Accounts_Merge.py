...
"Ethan0@m.co"],["Hanzo","Hanzo3@m.co","Hanzo1@m.co","Hanzo0@m.co"],["Fern","Fern5@m.co",
...
class Solution:
    def accountsMerge(self, accounts):
        ...
        # Creating two dictionaries to hold
        # email: name
        # email: position of name in the accounts array 
        email_name = {}
        email_pos = {}
        ...
        for account in accounts:
            ...
            # Consider emails in the specific sub-array 
            for email in account[1:]:
                ...
                if email not in email_pos:
                    email_pos[email] = i
                    i += 1
                disjoint.union(email_pos[account[1]], email_pos[email]) 
        
        # Get a defaultdict(list), as it won't throw out of bound errors
        ans = collections.defaultdict(list)
        for email in email_name:
            ans[disjoint.find(email_pos[email])].append(email)
        
        #Sort the array 'v' before adding tbe name in front.
