...
class Solution:
    def pivotIndex(self, nums: List[int]) -> int:
        # Create a left sum to track sum after you element has been visisted. 
        leftSum = 0
        
        # Using the total sum of that array, a pivot can be found. 
        totalSum = sum(nums)
        
        # Core logic -> totalSum - leftSum - nums[i] == leftSum -> nums[i] is the pivot. 
        # In other words, the sum of whatever you passed is equal to the remainder of the total sum 
        # then the point is the pivot of the array. 
